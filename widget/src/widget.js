(function () {
  ...
  styles.textContent =
    "#cb-root{all:initial;font-family:system-ui,-apple-system,Segoe UI,Roboto,sans-serif}" +
    "#cb-root *{box-sizing:border-box;font-family:inherit}" +
    "#cb-toggle{position:fixed;right:20px;bottom:20px;width:56px;height:56px;border-radius:50%;border:none;cursor:pointer;box-shadow:0 4px 16px rgba(0,0,0,.2);z-index:999998;color:#fff;font-size:24px;display:flex;align-items:center;justify-content:center}" +
    ...
    "#cb-close{background:transparent;border:none;color:#fff;font-size:22px;cursor:pointer;line-height:1;padding:0 4px}" +
    ...
    "#cb-send{border:none;border-radius:10px;padding:0 14px;font-size:14px;font-weight:600;color:#fff;cursor:pointer;min-width:72px}" +
  ...
  function applyTheme(color) {
    ...
    document.getElementById("cb-header").style.background = c;
